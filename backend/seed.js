...
const events = [
  ...
  },
  {
    ...
    ticketTiers: [
      { name: 'General Admission', price: 45, capacity: 500, description: 'Floor / GA — subject to venue layout' },
      { name: 'VIP', price: 95, capacity: 120, description: 'VIP area / express entry — details via Eventbrite' },
      { name: 'Premium VIP', price: 175, capacity: 40, description: 'Premium table experience — limited' },
    ],
    featured: true,
    status: 'upcoming',
    dateComingSoon: false,
